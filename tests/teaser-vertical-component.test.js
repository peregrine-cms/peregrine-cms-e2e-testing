/**
 * single-test run:
 * npm run test -- ./tests/teaser-vertical-component.test.js
 * npm run test:headful -- ./tests/teaser-vertical-component.test.js
 */
...
Scenario('sync title to editor-panel', async ({ editPagePage }) => {
  ...
  expect(await editPagePage.editorPanel.grabNthInputValue(1)).toBe(text);
